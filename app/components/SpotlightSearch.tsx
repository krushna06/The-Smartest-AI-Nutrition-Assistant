                      ...
                      {searchResults.map((result, index) => (
                        ...
                        >
                          <div className="w-6 flex-shrink-0 flex items-center justify-center">
                            <MessageSquare
                              size={16}
                              className="text-[#8f8f8f] group-hover:text-[#e0e0e0] transition-colors"
                            />
                          </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex space-x-4">
                  ...
                  >
                    Press{" "}
                    <kbd className="mx-1 px-1.5 py-0.5 bg-[#2a2a2a] rounded text-[#e0e0e0]">
                      ↑↓
                    </kbd>{" "}
                    to navigate
                  </motion.span>
                ...
                >
                  Press{" "}
                  <kbd className="ml-1 px-1.5 py-0.5 bg-[#2a2a2a] rounded text-[#e0e0e0]">
                    Esc
                  </kbd>{" "}
                  to close
                </motion.span>
